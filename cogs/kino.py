...
class SearchKino:
    def __init__(self, key) -> None:
        self.key = key
        res = requests.get(
            f"https://api.themoviedb.org/3/search/movie?api_key=88637c22a27d11937d1168157cf81ce9&language=en-US&query={key}&page=1")
...
class Kino:
    def __init__(self, id) -> None:
        self.id = id
        res = requests.get(
            f"https://api.themoviedb.org/3/movie/{id}?api_key=88637c22a27d11937d1168157cf81ce9&language=en-US")
        ...
        res2 = requests.get(
            f"https://api.themoviedb.org/3/movie/{id}/credits?api_key=88637c22a27d11937d1168157cf81ce9&language=en-US")
